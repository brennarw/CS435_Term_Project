...
public final class RandomForestBirds {
    ...
    public static void trainRandomForest(SparkSession spark, String inputData, String outputPath) throws IOException {
        ...
        StringIndexer labelIndexer = new StringIndexer()
                                     .setInputCol("bird_strike/flight")
        ...
        Dataset<Row>[] splits = data.randomSplit(new double[]{0.8, 0.2}, 1337);
        ...
        predictions.select("airport_code", "bird_population", "bird_strike/flight", "prediction").show();
